...
void UDatasetMetadataWriter::CreateFile() const
{
    ...
    {
        FString Header = TEXT("Image;Object;Level;Class;Material;Camera Position;Light Color (RGB);Fog;Mask\n");
...
{
    FString LineToWrite = FString::Printf(TEXT("%s;%s;%s;%s;%s;%s;%s;%s;%s\n"),
        *m_sImageName,
        *m_sModelName,
        *m_sLevelName,
        *m_sClassIndex,
